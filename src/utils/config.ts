...
export type GlobalConfig = {
  ...
  // Third-party provider configuration (set via /model command)
  openaiModel?: string // OpenAI model to use (e.g. gpt-4o, gpt-4o-mini)
  openaiApiKey?: string // OpenAI API key (stored in config, not env)
  openaiBaseUrl?: string // Custom OpenAI-compatible API base URL
}
